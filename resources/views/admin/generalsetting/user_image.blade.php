                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview" style="background: url({{ $gs->user_image ? asset('public/assets/images/'.$gs->user_image):asset('public/assets/images/noimage.png') }});">
