						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('public/assets/images/admins/'.$data->photo) : asset('public/assets/images/noimage.png') }});">
