          ...
          <div class="body-area">
            ...
            <form action="{{ route('admin-gs-update-payment') }}" id="geniusform" method="POST"
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Paypal Email') }}" name="paypal_business"
                    value="{{ $gs->paypal_business }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <div class="action-list">
                    <select
                      class="process select droplinks {{ $gs->is_instamojo == 1 ? 'drop-success' : 'drop-danger' }}">
                      <option data-val="1" value="{{route('admin-gs-instamojo',1)}}" {{ $gs->is_instamojo == 1 ?
                        'selected' : '' }}>{{ __('Activated') }}</option>
                      <option data-val="0" value="{{route('admin-gs-instamojo',0)}}" {{ $gs->is_instamojo == 0 ?
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Instamojo API Key') }}"
                    name="instamojo_key" value="{{ $gs->instamojo_key }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Instamojo Auth Token') }}"
                    name="instamojo_token" value="{{ $gs->instamojo_token }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <label class="switch">
                    <input type="checkbox" name="instamojo_sandbox" value="1" {{ $gs->instamojo_sandbox == 1 ?
                    "checked":"" }}>
                ...
                <div class="col-lg-6">
                  <div class="action-list">
                    <select class="process select droplinks {{ $gs->is_paytm == 1 ? 'drop-success' : 'drop-danger' }}">
                      <option data-val="1" value="{{route('admin-gs-paytm',1)}}" {{ $gs->is_paytm == 1 ? 'selected' : ''
                        }}>{{ __('Activated') }}</option>
                      <option data-val="0" value="{{route('admin-gs-paytm',0)}}" {{ $gs->is_paytm == 0 ? 'selected' : ''
                        }}>{{ __('Deactivated') }}</option>
                    </select>
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Paytm Merchant') }}" name="paytm_merchant"
                    value="{{ $gs->paytm_merchant }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Paytm Secret') }}" name="paytm_secret"
                    value="{{ $gs->paytm_secret }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Paytm Website') }}" name="paytm_website"
                    value="{{ $gs->paytm_website }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Paytm Industry') }}" name="paytm_industry"
                    value="{{ $gs->paytm_industry }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <textarea class="input-field" name="paytm_text"
                    placeholder="{{ __('Paytm Text') }}">{{ $gs->paytm_text }}</textarea>
                ...
                <div class="col-lg-6">
                  <div class="action-list">
                    <select class="process select droplinks {{ $gs->is_molly == 1 ? 'drop-success' : 'drop-danger' }}">
                      <option data-val="1" value="{{route('admin-gs-molly',1)}}" {{ $gs->is_molly == 1 ? 'selected' : ''
                        }}>{{ __('Activated') }}</option>
                      <option data-val="0" value="{{route('admin-gs-molly',0)}}" {{ $gs->is_molly == 0 ? 'selected' : ''
                        }}>{{ __('Deactivated') }}</option>
                    </select>
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <textarea class="input-field" name="molly_key" placeholder="{{ __('Molly Key') }}"
                    required>{{ $gs->molly_key }}</textarea>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <textarea class="input-field" name="molly_text" placeholder="{{ __('Molly Text') }}"
                    required>{{ $gs->molly_text }}</textarea>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <textarea class="input-field" name="razorpay_text" placeholder="{{ __('Razorpay Text') }}"
                    required>{{ $gs->razorpay_text }}</textarea>
                ...
                <div class="col-lg-6">
                  <div class="action-list">
                    <select
                      ...
                      <option data-val="1" value="{{route('admin-gs-guest',1)}}" {{ $gs->guest_checkout == 1 ?
                        'selected' : '' }}>{{ __('Activated') }}</option>
                      <option data-val="0" value="{{route('admin-gs-guest',0)}}" {{ $gs->guest_checkout == 0 ?
                        'selected' : '' }}>{{ __('Deactivated') }}</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="action-list">
                    <select class="process select droplinks {{ $gs->cod_check == 1 ? 'drop-success' : 'drop-danger' }}">
                      <option data-val="1" value="{{route('admin-gs-cod',1)}}" {{ $gs->cod_check == 1 ? 'selected' : ''
                        }}>{{ __('Activated') }}</option>
                      <option data-val="0" value="{{route('admin-gs-cod',0)}}" {{ $gs->cod_check == 0 ? 'selected' : ''
                        }}>{{ __('Deactivated') }}</option>
                    </select>
                  </div>
                </div>
...
{{-- 
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Withdraw Fee') }}" name="withdraw_fee"
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Withdraw Charge(%)') }}"
                    name="withdraw_charge" value="{{ $gs->withdraw_charge }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Tax(%)') }}" name="tax"
                    value="{{ $gs->tax }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-3">
                  <div class="left-area">
                    ...
                    <p class="sub-heading">{{ __("(If you don't want to add any fixed commission, just set it to 0)") }}
                    </p>
                  </div>
                </div>
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Fixed Commission') }}"
                    name="fixed_commission" value="{{ $gs->fixed_commission }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-3">
                  <div class="left-area">
                    ...
                    <p class="sub-heading">{{ __("(If you don't want to add any percentage commission, just set it to
                      0)") }}</p>
                  </div>
                </div>
                <div class="col-lg-6">
                  <input type="text" class="input-field" placeholder="{{ __('Percentage Commission') }}"
                    name="percentage_commission" value="{{ $gs->percentage_commission }}" required="">
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  <label class="switch">
                    <input type="checkbox" name="multiple_shipping" value="1" {{ $gs->multiple_shipping == 1 ?
                    "checked":"" }}>
                    <span class="slider round"></span>
                  </label>
                </div>
