                    ...
                    <div class="table-responsiv  dashboard-home-table">
                        <table id="poproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img
                                            src="{{filter_var($data->photo, FILTER_VALIDATE_URL) ?$data->photo:asset('public/assets/images/products/'.$data->photo)}}">
                                    </td>
                                    <td>{{ strlen(strip_tags($data->name)) > 50 ?
                                        substr(strip_tags($data->name),0,50).'...' : strip_tags($data->name) }}</td>
