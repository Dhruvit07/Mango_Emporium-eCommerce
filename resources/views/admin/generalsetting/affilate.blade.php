                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview" style="background: url({{ $gs->affilate_banner ? asset('public/assets/images/'.$gs->affilate_banner):asset('public/assets/images/noimage.png') }});">
