                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('public/assets/images/partner/'.$data->photo):asset('public/assets/images/noimage.png') }});">
